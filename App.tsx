...
import { Plus, LayoutGrid, List as ListIcon, Link as LinkIcon, Trash2, Lock, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
       <SignedOut>
        ...
        {isTrashOpen && (
          <TrashModal
            trashPublicLinks={trashPublicLinks}
            trashPersonalizedLinks={trashPersonalizedLinks}
